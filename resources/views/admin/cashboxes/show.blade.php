...
@section('title', trans('accounting::accounting.reports.treasury_statement.cashbox_title', ['name' => $cashbox->name]))
@section('content')
@php
...
@endphp
<div class="container-fluid" data-role="cashbox-statement-show">
    <div class="card mb-3">
        <div class="card-body">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                <div>
                    <h4 class="mb-1">{{ trans('accounting::accounting.reports.treasury_statement.cashbox_title', ['name' => $cashbox->name]) }}</h4>
                    <p class="text-muted mb-0 small">
                        {{ trans('accounting::accounting.reports.treasury_statement.account_label') }}:
                        <strong>{{ $cashbox->account?->code ?? '-' }}</strong>
                        @if(!empty($cashbox->account?->name))
                            — {{ $cashbox->account->name }}
                        @endif
                    </p>
                </div>
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('admin.accounting.cashboxes.index') }}" class="btn btn-light">
                        <i class="ph-arrow-left me-1"></i>{{ trans('accounting::accounting.reports.treasury_statement.back_to_list') }}
                    </a>
                    <a href="{{ route('admin.accounting.cashboxes.edit', ['cashbox' => $cashbox->id]) }}" class="btn btn-outline-primary">
        ...
        <div class="card-body">
            <form method="GET" class="row g-3 align-items-end">
                ...
                <div class="col-md-8 d-flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('admin.accounting.cashboxes.show', ['cashbox' => $cashbox->id]) }}" class="btn btn-outline-secondary">
    ...
    @else
        ...
        <div class="card mb-3">
            <div class="card-body d-flex flex-wrap justify-content-between align-items-center gap-3">
                ...
                <div>
                    <form method="POST" action="{{ route('admin.accounting.treasury-sync.sync-one', ['type' => 'cashbox', 'id' => $cashbox->id]) }}">
                        @csrf
