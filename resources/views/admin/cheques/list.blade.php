...
@section('content')
    ...
    @include('accounting::components.collapse_help_card', [
        'collapseId' => 'admin-cheques-help',
        'cardClass' => 'mt-3',
        'toggleLabel' => trans('accounting::accounting.cheques.help.toggle'),
        'title' => trans('accounting::accounting.cheques.help.title'),
        'paragraphs' => [
            trans('accounting::accounting.cheques.help.p1'),
            trans('accounting::accounting.cheques.help.p2'),
            trans('accounting::accounting.cheques.help.p3'),
            trans('accounting::accounting.cheques.help.p4'),
            trans('accounting::accounting.cheques.help.p5'),
            trans('accounting::accounting.cheques.help.p6'),
        ],
    ])
