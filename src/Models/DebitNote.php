...
/**
 * Debit Note (یادداشت بدهکار)
 * 
 * استاندارد: IAS 2 - Inventories
 * 
 * زمانی که:
 * - ما کالا را به تامین‌کننده برمی‌گردانیم
 * - تخفیف بعد از فاکتور خرید دریافت می‌کنیم
 * - اصلاح خطا در فاکتور خرید
 */
class DebitNote extends Model
{
    ...
    {
        return $this->belongsTo(SupplierInvoice::class, 'applied_to_invoice_id');
    }
